        ...
        <div class="container py-5">
            ...
            <div class="card shadow mb-4 col">
                <div class="card-header py-3">
                    <div class="">
                        <div class="">
                            <h6 class="m-0 font-weight-bold text-primary">User Profile ( <span class="text-danger">
                                    {{ Auth::user()->role }}</span> ) </h6>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-3">
                                ...
                                <img class="img-profile img-thumbnail" id="output"
                                    src="{{ Auth::user()->profile != null ? asset('profile/' . Auth::user()->profile) : asset('default/profilePicture.jpg') }}">
                            ...
                            <div class="col">
                                ...
                                <div class="my-2">
                                    <a href="{{ route('user#homepage') }}"
                                        class="btn  bg-dark mt-2  text-white shadow-sm rounded">Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
