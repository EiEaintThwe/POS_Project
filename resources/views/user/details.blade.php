        ...
        <div class="container py-5">
            <div class="row g-4 mb-5">
                <div class="col-lg-8 col-xl-9">
                    <a href="{{ route('user#homepage') }}"> Home </a> <i class=" mx-1 mb-4 fa-solid fa-greater-than"></i> Details
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="rounded text-center">
                                <a href="#">
                                    <img src="{{ asset('productImage/'.$product->image) }}" class="img-fluid" alt="Image">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <h4 class="fw-bold text-warning h1">{{ $product->name }}</h4>
                            <span class="text-danger my-3 h5">(Only {{ $product->stock }} items left ! )</span>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="tab-content mb-5">
                                ...
                                <div class="tab-pane" id="nav-mission" role="tabpanel"
                                    ...
                                    <div class="d-flex">
                                        <img src="{{ asset($item->profile == null ? 'default/profilePicture.jpg' : 'profile/'.$item->profile) }}" class="img-fluid rounded-circle p-3"
                                            style="width: 100px; height: 100px;">
                                        <div class="">
                                            <p class="" style="font-size: 14px;"> {{ $item->created_at->format('j-F-Y') }} </p>
                                            <div class="d-flex">
                                                <h5>{{ $item->name }}</h5>
                                                @if ($item->user_id == Auth::user()->id)
                                                <button type="button" onclick="deleteProcess({{ $item->comment_id }})" class="btn btn-sm shadow-sm rounded mx-4 btn-outline-danger"><i class="fa-solid fa-trash mx-2"></i>Delete Comment</button>
