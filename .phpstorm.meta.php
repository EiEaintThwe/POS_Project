...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./opt/lampp/htdocs/pos_project/public/storage' => 'string',
...
'cors.max_age','cors.supports_credentials','view.paths','view.compiled','concurrency.default',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./opt/lampp/htdocs/pos_project/public/storage','logging.default','logging.deprecations.channel',
...
'session.same_site','session.partitioned','session.serialization','sweetalert.theme','sweetalert.cdn',
...
'sweetalert.confirm_delete_show_loader_on_confirm','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'signed','throttle','verified','adminMiddleware','userMiddleware',
'superAdminMiddleware','authenticatedMiddleware',);
        registerArgumentsSet('routes', 'admin#dashboard','category#list','category#create','category#delete',
'category#edit','category#update','product#createPage','product#list','product#create',
'product#delete','product#edit','product#update','product#details','profile#changePasswordPage',
'profile#changePassword','profile#editProfile','profile#update','payment#list','payment#create',
'payment#delete','payment#edit','payment#update','account#createAdminPage','account#createAdmin',
'account#adminList','account#adminDelete','account#userList','account#userDelete','user#homepage',
'user#productDetails','user#comment','user#commentDelete','user#rating','user#editProfile',
'user#updateProfile','user#changePasswordPage','user#changePassword','register',
'login','password.request','password.email','password.reset',
'password.store','verification.notice','verification.verify','verification.send','password.confirm','password.update','logout','dashboard',
'profile.edit','profile.update','profile.destroy','socialLogin','socialCallback',
'storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'admin.account.adminList','admin.account.newAdmin','admin.account.userList','admin.category.edit','admin.category.list',
'admin.dashboard.main','admin.layouts.master','admin.payment.edit','admin.payment.list','admin.product.create',
'admin.product.details','admin.product.edit','admin.product.list','admin.profile.changePassword','admin.profile.edit',
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'auth.verify-email','authentication.layouts.master','authentication.login','authentication.register','components.application-logo',
...
'components.secondary-button','components.text-input','layouts.app','layouts.guest','layouts.navigation',
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','sweetalert::alert',
'user.details','user.home','user.layouts.master','user.profile.changePassword','user.profile.edit',
'vendor.sweetalert.alert','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
...
'pagination::simple-tailwind','pagination::tailwind','sweetalert::alert',);
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','GITHUB_CLIENT_ID','GITHUB_CLIENT_SECRET',
